...
в тексте. Слой без выясненных прав или без ссылки на источник — это не
«почти готово», это незаконченная работа.
"""
...
# Формулировки, которые ничего не сообщают о правах. Их наличие означает,
# что вопрос не выяснен, а не что он выяснен и сложен.
...
def test_rights_are_stated_in_words():
    """Условие приёмки: права выяснены и записаны, а не отложены."""
    for spec in ALL_LAYERS:
...
AWAITING_COLLECTOR = {
    ...
    "weather_chronicles", "drought_atlas",
}
