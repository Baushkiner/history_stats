...
# Языки подписи и порядок их перебора. Русский и английский стоят первыми,
# поэтому у объекта, подписанного по-русски, название не меняется: сервис
# берёт первый доступный язык из списка. Остальные — языки территории плюс
# несколько западных на самый край.
#
# Список нужен потому, что «ru,en» оставляли без названия каждую восьмую
# запись: сервис возвращает в таком случае голый Q-номер, и на карту шло
# «Q16617021». Замер 29.08.2026 на 223 таких записях из четырнадцати слоёв:
# подпись хоть на одном языке есть у всех до единой, чаще всего польская
# (65%), затем литовская, украинская, финская, латышская, белорусская,
# румынская, эстонская. Языки территории закрывают 99%, оставшиеся два
# объекта подписаны только по-французски — отсюда `fr` и `nl` в хвосте.
#
# Проба на 500 храмах (250 безымянных, 250 с названием): имя получили 249 из
# 250, ни одно уже имевшееся название не изменилось, ответ подорожал с 5,0 до
# 6,8 секунды на чанк.
#
# Название приходит на языке места: волынская церковь будет «Cerkiew
# Narodzenia św. Jana Chrzciciela», латвийская — «Augškalnes ... baznīca».
# Это и есть местное написание, но искать по нему по-русски нельзя — задача
# указателя написаний, а не слоя.
LABEL_LANGS = "ru,en,uk,be,pl,lt,lv,et,fi,ro,hy,ka,az,kk,ky,uz,tg,tk,tr,de,sv,fr,nl"
