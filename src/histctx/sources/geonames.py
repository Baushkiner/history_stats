...
собрать здесь, а не через Викиданные: запрос `queries/settlements_wd.rq`
никуда не делся и остаётся вторым источником для сведения — под своим slug'ом
`settlements_wd`, чтобы сбор из Викиданных не затирал этот слой и не менял
ему лицензию.
